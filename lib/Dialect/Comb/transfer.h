...
std::tuple<APInt,APInt> shiftByConst(std::tuple<APInt,APInt> arg0,APInt arg1){
  APInt arg0_0=std::get<0>(arg0);
  APInt arg0_1=std::get<1>(arg0);
  APInt result_0_tmp=arg0_0.shl(arg1.getZExtValue());
  APInt result_0=result_0_tmp;
  result_0.setLowBits(arg1.getZExtValue());
  APInt result_1=arg0_1.shl(arg1.getZExtValue());
  std::tuple<APInt,APInt> result=std::make_tuple(result_0,result_1);
  return result;
}
int isUnknown(std::tuple<APInt,APInt> arg0){
  APInt arg0_0=std::get<0>(arg0);
  APInt arg0_1=std::get<1>(arg0);
  APInt const0(arg0_0.getBitWidth(),0);
  int result_0=arg0_0.eq(const0);
  int result_1=arg0_1.eq(const0);
  int result=result_0&result_1;
  return result;
}
std::tuple<APInt,APInt> shlLHSFastPath(std::tuple<APInt,APInt> arg0,std::tuple<APInt,APInt> arg1){
  APInt arg0_0=std::get<0>(arg0);
  APInt arg0_1=std::get<1>(arg0);
  APInt arg1_min=getMinValue(arg1);
  APInt result_0=arg0_0;
  result_0.setLowBits(arg1_min.getZExtValue());
  std::tuple<APInt,APInt> result=std::make_tuple(result_0,arg0_1);
  return result;
}
std::tuple<APInt,APInt> shlRHSFastPath(std::tuple<APInt,APInt> arg0,std::tuple<APInt,APInt> arg1){
  APInt arg0_0=std::get<0>(arg0);
  APInt arg0_1=std::get<1>(arg0);
  unsigned arg0_0_rones_autocast=arg0_0.countr_one();
  APInt arg0_0_rones(arg0_0.getBitWidth(),arg0_0_rones_autocast);
  APInt arg1_min=getMinValue(arg1);
  APInt result_0=arg0_0;
  result_0.setLowBits(arg1_min.getZExtValue());
  std::tuple<APInt,APInt> result=std::make_tuple(result_0,arg0_1);
...
std::tuple<APInt,APInt> SHLImpl(std::tuple<APInt,APInt> arg0,std::tuple<APInt,APInt> arg1){
  ...
  APInt arg0_1=std::get<1>(arg0);
  APInt const0(arg0_0.getBitWidth(),0);
  APInt const1(arg0_0.getBitWidth(),1);
  unsigned bitwidth_autocast=arg0_0.getBitWidth();
  APInt bitwidth(arg0_0.getBitWidth(),bitwidth_autocast);
  APInt result_tmp_0 = APInt::getAllOnes(arg0_0.getBitWidth());
  APInt result_tmp_1 = APInt::getAllOnes(arg0_0.getBitWidth());
  std::tuple<APInt,APInt> result_tmp=std::make_tuple(result_tmp_0,result_tmp_1);
  std::tuple<APInt,APInt> tmp = result_tmp;
  for(APInt ind = const0; ind.ule(bitwidth); ind+=const1){
    APInt tmp_0=std::get<0>(tmp);
    APInt tmp_1=std::get<1>(tmp);
    int isValidShift=getInstanceConstraint(arg1,ind);
    std::tuple<APInt,APInt> tmp_shift=shiftByConst(arg0,ind);
    std::tuple<APInt,APInt> intersection_tmp=intersection(tmp,tmp_shift);
    APInt intersection_tmp_0=std::get<0>(intersection_tmp);
    APInt intersection_tmp_1=std::get<1>(intersection_tmp);
    APInt tmp_res_0=isValidShift ? intersection_tmp_0 : tmp_0 ;
    APInt tmp_res_1=isValidShift ? intersection_tmp_1 : tmp_1 ;
    std::tuple<APInt,APInt> tmp_for_res=std::make_tuple(tmp_res_0,tmp_res_1);
    tmp = tmp_for_res;
  }
  std::tuple<APInt,APInt> for_res = tmp;
  APInt for_res_0=std::get<0>(for_res);
  APInt for_res_1=std::get<1>(for_res);
  int conflict=for_res_1.intersects(for_res_0);
  APInt result_0=conflict ? const0 : for_res_0 ;
  APInt result_1=conflict ? const0 : for_res_1 ;
  std::tuple<APInt,APInt> result=std::make_tuple(result_0,result_1);
  return result;
}
